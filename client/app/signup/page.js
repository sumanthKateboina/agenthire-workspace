...
export default function Signup() {
  ...
  return (
    <div className="flex min-h-screen flex-col justify-center bg-slate-950 py-12 sm:px-6 lg:px-8 text-white relative overflow-hidden">
      {/* Blurs */}
      <div className="absolute top-10 right-10 h-72 w-72 rounded-full bg-blue-500/10 blur-[80px]"></div>
      <div className="absolute bottom-10 left-10 h-72 w-72 rounded-full bg-indigo-500/10 blur-[80px]"></div>
